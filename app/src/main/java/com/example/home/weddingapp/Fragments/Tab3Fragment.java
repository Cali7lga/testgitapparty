 ...
 * {@link Tab3Fragment.Tab3FragmentInteractionListener} interface
...
public class Tab3Fragment extends Fragment {
    ...
    private Tab3FragmentInteractionListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onTab3FragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof Tab3FragmentInteractionListener) {
            mListener = (Tab3FragmentInteractionListener) context;
        } else {
     ...
     */
    public interface Tab3FragmentInteractionListener {
        // TODO: Update argument type and name
        void onTab3FragmentInteraction(Uri uri);
    }
}
